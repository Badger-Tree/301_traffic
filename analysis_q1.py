...
from db import get_crashes, get_filtered_populations, get_crashes_per_municipality,get_crashes_per_100k
...
# ##########################
# crashes_per_municipality.sort_values("total_crashes", ascending=False).head(10).plot.bar( x="municipality", y = "total_crashes", color = ["blue"])
...
# #############################
# crashes_per_municipality.sort_values("total_victims", ascending=False).head(10).plot.bar( x="municipality", y = "total_victims", color = ["green"])
# plt.xlabel("Municipality")
